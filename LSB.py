...
def encode_lsb(original_image_path, secret_image_path, password):
    ...
    key = ''.join(format(ord(char), '08b') for char in password)
...
encode_lsb('/home/yassg4mer/Project/SAFM/images bmp/lenat.bmp', '/home/yassg4mer/Project/SAFM/images bmp/user.bmp', 'password')
decode_lsb('encoded_image.png', 'password')

encode_lsb2('/home/yassg4mer/Project/SAFM/images bmp/lenat.bmp', '/home/yassg4mer/Project/SAFM/images bmp/user.bmp', 'password')
decode_lsb2('encoded_image_lsb2.png', 'password')

encode_lsb3('/home/yassg4mer/Project/SAFM/images bmp/lenat.bmp', '/home/yassg4mer/Project/SAFM/images bmp/user.bmp', 'password')
